...
## Generated on : Sat Feb 25 20:53:54 2017
...
DEFINES_BUILD_ARGS = -DMAT_FILE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=1 -DONESTEPFCN=1 -DTERMFCN=1 -DMULTI_INSTANCE_CODE=1
DEFINES_IMPLIED = -DTID01EQ=1
DEFINES_OPTS = -DRT_MALLOC
DEFINES_STANDARD = -DMODEL=DynModel -DNUMST=2 -DNCSTATES=17 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/DynModel_grt_rtw/DynModel.c $(START_DIR)/DynModel_grt_rtw/DynModel_data.c $(MATLAB_ROOT)/rtw/c/src/common/rt_malloc_main.c
