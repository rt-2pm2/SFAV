...
real_T Kvreact = 120.0;                /* Variable: Kvreact
                                        ...
                                        */
real_T Kwreact = 0.08;                 /* Variable: Kwreact
                                        * Referenced by: '<S5>/Gain4'
                                        */
real_T sys_step_time = 0.002;
...
void DynModel_step(RT_MODEL_DynModel_T *const DynModel_M)
{
  ...
  if (DynModel_B->Sum1 > 11000.0) {
    rtb_Sum_c_idx_0 = 11000.0;
  } else if (DynModel_B->Sum1 < 0.0) {
    rtb_Sum_c_idx_0 = 0.0;
  } else {
    rtb_Sum_c_idx_0 = DynModel_B->Sum1;
  }
   ...
   *  Saturate: '<S64>/Limit  altitude  to troposhere'
   */
  DynModel_B->Sum1_e = 288.15 - 0.0065 * rtb_Sum_c_idx_0;
  if (rtmIsMajorTimeStep(DynModel_M)) {
  ...
  /* Math: '<S64>/(T//T0)^(g//LR) ' */
  if (rtb_jxi < 0.0) {
    rtb_ixk_p = -pow(-rtb_jxi, 5.2558756014667134);
  } else {
    rtb_ixk_p = pow(rtb_jxi, 5.2558756014667134);
  }
  ...
  if (11000.0 - DynModel_B->Sum1 > 0.0) {
    ...
    rtb_Sum_c_idx_0 = -9000.0;
  } else {
    rtb_Sum_c_idx_0 = 11000.0 - DynModel_B->Sum1;
  }
   ...
   *  Operator: exp
   */
  rtb_kxj_p = exp(1.0 / DynModel_B->Sum1_e * (0.034163191409533639 *
    rtb_Sum_c_idx_0));

  /* Product: '<S64>/Product2' incorporates:
   *  Gain: '<S64>/P0'
   */
  DynModel_B->Product2 = 101325.0 * rtb_ixk_p * rtb_kxj_p;
  if (rtmIsMajorTimeStep(DynModel_M)) {
   ...
   *  Product: '<S64>/Product'
   */
  DynModel_B->Product3 = rtb_ixk_p / rtb_jxi * 1.225 * rtb_kxj_p;
  ...
  if (rtmIsMajorTimeStep(DynModel_M)) {
    ...
    /* Gain: '<S102>/Unit Conversion' incorporates:
     *  Product: '<S101>/rad lat'
     *  Product: '<S101>/rad long '
     *  RandomNumber: '<S63>/Random Number'
     *  Sum: '<S63>/Add1'
     */
    rtb_Add3_idx_0 = (DynModel_DW->NextOutput_o[0] + DynModel_B->xeyeze[0]) *
      1.5784225029068334E-7 * 57.295779513082323;
    rtb_Add3_idx_1 = (DynModel_DW->NextOutput_o[1] + DynModel_B->xeyeze[1]) *
      1.5678559428873849E-7 * 57.295779513082323;
     ...
     *  Sum: '<S98>/Sum'
     */
    if (fabs(rtb_Add3_idx_0) > 180.0) {
      rtb_Switch = rt_modd(rtb_Add3_idx_0 + 180.0, 360.0) + -180.0;
    } else {
      rtb_Switch = rtb_Add3_idx_0;
    }
     ...
     *  Sum: '<S98>/Sum'
     */
    rtb_Abs1 = (rtb_Add3_idx_1 + DynModel_ConstB.Switch_d) + (real_T)rtb_y;
     ...
     */
    if (fabs(rtb_Abs1) > 180.0) {
      rtb_Abs1 = rt_modd(rtb_Abs1 + 180.0, 360.0) + -180.0;
    }
   ...
   *  Sum: '<S33>/Sum'
   */
  rtb_kxj_p = sqrt(((rtb_q0q1q2q3[0] * rtb_q0q1q2q3[0] + rtb_q0q1q2q3[1] *
                     rtb_q0q1q2q3[1]) + rtb_q0q1q2q3[2] * rtb_q0q1q2q3[2]) +
                   rtb_q0q1q2q3[3] * rtb_q0q1q2q3[3]);

  /* Product: '<S31>/Product' */
  rtb_ixk_p = rtb_q0q1q2q3[0] / rtb_kxj_p;

  /* Product: '<S31>/Product1' */
  rtb_jxi = rtb_q0q1q2q3[1] / rtb_kxj_p;

  /* Product: '<S31>/Product2' */
  rtb_Sum_c_idx_0 = rtb_q0q1q2q3[2] / rtb_kxj_p;

  /* Product: '<S31>/Product3' */
  rtb_kxj_p = rtb_q0q1q2q3[3] / rtb_kxj_p;
   ...
   */
  DynModel_B->VectorConcatenate[0] = ((rtb_ixk_p * rtb_ixk_p + rtb_jxi * rtb_jxi)
    - rtb_Sum_c_idx_0 * rtb_Sum_c_idx_0) - rtb_kxj_p * rtb_kxj_p;
   ...
   *  Sum: '<S24>/Sum'
   */
  DynModel_B->VectorConcatenate[1] = (rtb_jxi * rtb_Sum_c_idx_0 - rtb_kxj_p *
    rtb_ixk_p) * 2.0;
   ...
   *  Sum: '<S27>/Sum'
   */
  DynModel_B->VectorConcatenate[2] = (rtb_ixk_p * rtb_Sum_c_idx_0 + rtb_jxi *
    rtb_kxj_p) * 2.0;
   ...
   *  Sum: '<S22>/Sum'
   */
  DynModel_B->VectorConcatenate[3] = (rtb_kxj_p * rtb_ixk_p + rtb_jxi *
    rtb_Sum_c_idx_0) * 2.0;
   ...
   */
  DynModel_B->VectorConcatenate[4] = ((rtb_ixk_p * rtb_ixk_p - rtb_jxi * rtb_jxi)
    + rtb_Sum_c_idx_0 * rtb_Sum_c_idx_0) - rtb_kxj_p * rtb_kxj_p;
   ...
   *  Sum: '<S28>/Sum'
   */
  DynModel_B->VectorConcatenate[5] = (rtb_Sum_c_idx_0 * rtb_kxj_p - rtb_ixk_p *
    rtb_jxi) * 2.0;
   ...
   *  Sum: '<S23>/Sum'
   */
  DynModel_B->VectorConcatenate[6] = (rtb_jxi * rtb_kxj_p - rtb_ixk_p *
    rtb_Sum_c_idx_0) * 2.0;
   ...
   *  Sum: '<S26>/Sum'
   */
  DynModel_B->VectorConcatenate[7] = (rtb_ixk_p * rtb_jxi + rtb_Sum_c_idx_0 *
    rtb_kxj_p) * 2.0;
   ...
   */
  DynModel_B->VectorConcatenate[8] = ((rtb_ixk_p * rtb_ixk_p - rtb_jxi * rtb_jxi)
    - rtb_Sum_c_idx_0 * rtb_Sum_c_idx_0) + rtb_kxj_p * rtb_kxj_p;

  /* Product: '<S16>/Product' incorporates:
   *  Math: '<S4>/Transpose'
   */
  for (rtb_y = 0; rtb_y < 3; rtb_y++) {
    DynModel_B->Product[rtb_y] = 0.0;
    DynModel_B->Product[rtb_y] += DynModel_B->VectorConcatenate[3 * rtb_y] *
      DynModel_B->ubvbwb[0];
    DynModel_B->Product[rtb_y] += DynModel_B->VectorConcatenate[3 * rtb_y + 1] *
      DynModel_B->ubvbwb[1];
    DynModel_B->Product[rtb_y] += DynModel_B->VectorConcatenate[3 * rtb_y + 2] *
      DynModel_B->ubvbwb[2];
  }
  ...
  if (rtmIsMajorTimeStep(DynModel_M)) {
     ...
     */
    rtb_Add3_idx_0 = DynModel_U->Initial_LL[0] + rtb_Switch;
    rtb_Add3_idx_1 = DynModel_U->Initial_LL[1] + rtb_Abs1;

    /* Trigonometry: '<S63>/Trigonometric Function' */
    rtb_Switch = atan2(rtb_Add2_h_idx_1, rtb_Add2_h_idx_0);
  }
   ...
   *  Product: '<S149>/x*cos'
   */
  rtb_Sum_c_idx_0 = DynModel_B->xeyeze[0] * 1.5784225029068334E-7 *
    57.295779513082323;
  ...
  if ((rtb_Abs1 > 90.0) > 0) {
    ...
    rtb_Sum_c_idx_0 *= -(rtb_Abs1 + -90.0) + 90.0;
    rtb_y = 180;
  } else {
    rtb_y = 0;
  }
   ...
   *  Sum: '<S146>/Sum'
   */
  rtb_Sum_i = (1.5678559428873849E-7 * DynModel_B->xeyeze[1] *
               57.295779513082323 + DynModel_ConstB.Switch_b) + (real_T)rtb_y;

  /* Sum: '<S70>/Add1' incorporates:
   *  Inport: '<Root>/Initial_LL'
   */
  rtb_Add1_h_idx_0 = DynModel_U->Initial_LL[0] + rtb_Sum_c_idx_0;
  if (rtmIsMajorTimeStep(DynModel_M)) {
     ...
     */
    for (rtb_y = 0; rtb_y < 3; rtb_y++) {
      rtb_Add3_j[rtb_y] = DynModel_B->VectorConcatenate[rtb_y] +
    ...
    } else if (rtb_Add3_j[0] < -2.0) {
      rtb_Saturation_g_idx_0 = -2.0;
    } else {
      rtb_Saturation_g_idx_0 = rtb_Add3_j[0];
    }

    if (rtb_Add3_j[1] > 2.0) {
      rtb_Saturation_g_idx_1 = 2.0;
    } else if (rtb_Add3_j[1] < -2.0) {
      rtb_Saturation_g_idx_1 = -2.0;
    } else {
      rtb_Saturation_g_idx_1 = rtb_Add3_j[1];
    }

    if (rtb_Add3_j[2] > 2.0) {
      rtb_Saturation_g_idx_2 = 2.0;
    } else if (rtb_Add3_j[2] < -2.0) {
      rtb_Saturation_g_idx_2 = -2.0;
    } else {
      rtb_Saturation_g_idx_2 = rtb_Add3_j[2];
    }
     ...
     */
    rtb_TSamp[0] = rtb_Sum_h_idx_0 * 250.0;
    rtb_TSamp[1] = rtb_Sum_h_idx_1 * 250.0;
    rtb_TSamp[2] = rtb_Sum_h_idx_2 * 250.0;
     ...
     *  UnitDelay: '<S45>/UD'
     */
    DynModel_B->Gain13[0] = 0.0;
    DynModel_B->Gain13[1] = 0.0;
    DynModel_B->Gain13[2] = (Kpenetration * rtb_Sum_h_idx_2 + -11.772) +
      (rtb_TSamp[2] - DynModel_DW->UD_DSTATE[2]) * Kdpenetration;

    /* Gain: '<S5>/Gain11' */
    DynModel_B->Gain11[0] = -rtb_Sum_h_idx_0;
    DynModel_B->Gain11[1] = -rtb_Sum_h_idx_1;
    DynModel_B->Gain11[2] = -rtb_Sum_h_idx_2;
  }
  ...
  if (rtmIsMajorTimeStep(DynModel_M)) {
    ...
    if (DynModel_B->Gain11[0] >= 0.0) {
      DynModel_B->Switch2[0] = Kvreact * -rtb_Sum_h_idx_0;
    } else {
      DynModel_B->Switch2[0] = 0.0;
    }

    if (DynModel_B->Gain11[1] >= 0.0) {
      DynModel_B->Switch2[1] = Kvreact * -rtb_Sum_h_idx_1;
    } else {
      DynModel_B->Switch2[1] = 0.0;
    }

    if (DynModel_B->Gain11[2] >= 0.0) {
      DynModel_B->Switch2[2] = Kvreact * -rtb_Sum_h_idx_2;
    } else {
    ...
    DynModel_DW->DiscreteFilter_tmp = ((rtb_TSamp_l - DynModel_DW->UD_DSTATE_i) *
      Kdpenetration + Kpenetration * DynModel_U->pen_collision) - -0.8 *
   ...
   */
  for (rtb_y = 0; rtb_y < 3; rtb_y++) {
    rtb_Add3_j[rtb_y] = DynModel_B->VectorConcatenate[rtb_y + 6] *
      DynModel_U->n_collision[2] + (DynModel_B->VectorConcatenate[rtb_y + 3] *
      DynModel_U->n_collision[1] + DynModel_B->VectorConcatenate[rtb_y] *
  ...
  /* Product: '<S5>/Product2' */
  DynModel_B->Product2_n[0] = rtb_Add3_j[0] * DynModel_B->DiscreteFilter;
  DynModel_B->Product2_n[1] = rtb_Add3_j[1] * DynModel_B->DiscreteFilter;
  DynModel_B->Product2_n[2] = rtb_Add3_j[2] * DynModel_B->DiscreteFilter;
  if (rtmIsMajorTimeStep(DynModel_M)) {
    /* DiscreteFir: '<S5>/Discrete FIR Filter' */
    rtb_Sum_h_idx_2 = DynModel_B->Product2_n[0L];
    for (j = DynModel_DW->DiscreteFIRFilter_circBuf; j < 2L; j++) {
      rtb_Sum_h_idx_2 += DynModel_DW->DiscreteFIRFilter_states[j];
    }
    ...
    rtb_Sum_h_idx_0 = rtb_Sum_h_idx_2;
    rtb_Sum_h_idx_2 = DynModel_B->Product2_n[1L];
    for (j = DynModel_DW->DiscreteFIRFilter_circBuf; j < 2L; j++) {
      rtb_Sum_h_idx_2 += DynModel_DW->DiscreteFIRFilter_states[2L + j];
    }
    ...
    rtb_Sum_h_idx_1 = rtb_Sum_h_idx_2;
    rtb_Sum_h_idx_2 = DynModel_B->Product2_n[2L];
    for (j = DynModel_DW->DiscreteFIRFilter_circBuf; j < 2L; j++) {
      rtb_Sum_h_idx_2 += DynModel_DW->DiscreteFIRFilter_states[4L + j];
    }
     ...
     *  DiscreteFir: '<S5>/Discrete FIR Filter'
     */
    DynModel_B->Gain10[0] = 0.33333333333333331 * rtb_Sum_h_idx_0;
    DynModel_B->Gain10[1] = 0.33333333333333331 * rtb_Sum_h_idx_1;
    DynModel_B->Gain10[2] = 0.33333333333333331 * rtb_Sum_h_idx_2;
  }
  ...
  /* '<S46>:1:2' */
  rtb_Abs1 = 2.2250738585072014E-308;
  rtb_kxj_p = fabs(DynModel_U->n_collision[0]);
  if (rtb_kxj_p > 2.2250738585072014E-308) {
    rtb_jxi = 1.0;
    rtb_Abs1 = rtb_kxj_p;
  } else {
    rtb_Sum_c_idx_0 = rtb_kxj_p / 2.2250738585072014E-308;
    rtb_jxi = rtb_Sum_c_idx_0 * rtb_Sum_c_idx_0;
  }

  rtb_kxj_p = fabs(DynModel_U->n_collision[1]);
  if (rtb_kxj_p > rtb_Abs1) {
    rtb_Sum_c_idx_0 = rtb_Abs1 / rtb_kxj_p;
    rtb_jxi = rtb_jxi * rtb_Sum_c_idx_0 * rtb_Sum_c_idx_0 + 1.0;
    rtb_Abs1 = rtb_kxj_p;
  } else {
    rtb_Sum_c_idx_0 = rtb_kxj_p / rtb_Abs1;
    rtb_jxi += rtb_Sum_c_idx_0 * rtb_Sum_c_idx_0;
  }

  rtb_kxj_p = fabs(DynModel_U->n_collision[2]);
  if (rtb_kxj_p > rtb_Abs1) {
    rtb_Sum_c_idx_0 = rtb_Abs1 / rtb_kxj_p;
    rtb_jxi = rtb_jxi * rtb_Sum_c_idx_0 * rtb_Sum_c_idx_0 + 1.0;
    rtb_Abs1 = rtb_kxj_p;
  ...
  for (rtb_y = 0; rtb_y < 3; rtb_y++) {
     ...
     */
    if (rtb_y_0) {
      rtb_Abs1 = DynModel_B->Gain10[rtb_y];
    } else {
      rtb_Abs1 = 0.0;
    }
     ...
     *  Product: '<S5>/Matrix Multiply'
     */
    if (DynModel_B->Gain11[rtb_y] >= 0.0) {
      rtb_Sum_c_idx_0 = (DynModel_B->VectorConcatenate[rtb_y + 3] *
                         DynModel_B->Gain13[1] + DynModel_B->
                         VectorConcatenate[rtb_y] * DynModel_B->Gain13[0]) +
        DynModel_B->VectorConcatenate[rtb_y + 6] * DynModel_B->Gain13[2];
    } else {
      rtb_Sum_c_idx_0 = 0.0;
    }
    ...
    rtb_Add3_j[rtb_y] = (rtb_Sum_c_idx_0 + DynModel_B->Switch2[rtb_y]) +
      rtb_Abs1;
  }
  ...
  if (rtmIsMajorTimeStep(DynModel_M)) {
    ...
    if (DynModel_U->PWM1 > 1.0) {
      ...
      rtb_Sum_c_idx_0 = DynModel_U->PWM1;
    }
     ...
     */
    DynModel_DW->DiscreteTransferFcn_tmp = 12.0 * rtb_Sum_c_idx_0 * 950.0 *
    ...
    if (DynModel_U->PWM2 > 1.0) {
      ...
      rtb_Sum_c_idx_0 = DynModel_U->PWM2;
    }
     ...
     *  Saturate: '<S2>/Saturation'
     */
    DynModel_DW->DiscreteTransferFcn_tmp_i = 12.0 * rtb_Sum_c_idx_0 * 950.0 *
      0.10471975511965977 * 0.029126213592233007 - -0.9417475728155339 *
    ...
    if (DynModel_U->PWM3 > 1.0) {
      ...
      rtb_Sum_c_idx_0 = DynModel_U->PWM3;
    }
     ...
     *  Saturate: '<S2>/Saturation'
     */
    DynModel_DW->DiscreteTransferFcn_tmp_b = 12.0 * rtb_Sum_c_idx_0 * 950.0 *
      0.10471975511965977 * 0.029126213592233007 - -0.9417475728155339 *
    ...
    if (DynModel_U->PWM4 > 1.0) {
      ...
      rtb_Sum_c_idx_0 = DynModel_U->PWM4;
    }
     ...
     *  Saturate: '<S2>/Saturation'
     */
    DynModel_DW->DiscreteTransferFcn_tmp_e = 12.0 * rtb_Sum_c_idx_0 * 950.0 *
      0.10471975511965977 * 0.029126213592233007 - -0.9417475728155339 *
    ...
    /* --------------------------------Thrust Model------------------------------ */
    /* '<S51>:1:26' */
    rtb_Abs1 = 6.1235421348947671E-6 * rtb_Memory2;
  ...
  for (rtb_y = 0; rtb_y < 3; rtb_y++) {
    DynModel_B->MatrixMultiply1[rtb_y] = 0.0;
    DynModel_B->MatrixMultiply1[rtb_y] += DynModel_B->VectorConcatenate[rtb_y +
      6] * 9.81;
  }
  ...
  /* Product: '<S34>/Product' */
  rtb_kxj_p = rtb_q0q1q2q3[0] / rtb_Sum_c_idx_0;

  /* Product: '<S34>/Product1' */
  rtb_ixk_p = rtb_q0q1q2q3[1] / rtb_Sum_c_idx_0;

  /* Product: '<S34>/Product2' */
  rtb_jxi = rtb_q0q1q2q3[2] / rtb_Sum_c_idx_0;
   ...
   *  Fcn: '<S18>/fcn2'
   */
  DynModel_B->VectorConcatenate_i[0] = atan2((rtb_ixk_p * rtb_jxi + rtb_kxj_p *
    rtb_Sum_c_idx_0) * 2.0, ((rtb_kxj_p * rtb_kxj_p + rtb_ixk_p * rtb_ixk_p) -
    rtb_jxi * rtb_jxi) - rtb_Sum_c_idx_0 * rtb_Sum_c_idx_0);

  /* Fcn: '<S18>/fcn3' */
  rtb_Abs1 = (rtb_ixk_p * rtb_Sum_c_idx_0 - rtb_kxj_p * rtb_jxi) * -2.0;
  ...
  DynModel_B->VectorConcatenate_i[1] = asin(rtb_Abs1);

  /* End of Trigonometry: '<S18>/trigFcn' */

  /* Fcn: '<S18>/fcn4' */
  rtb_Abs1 = (rtb_jxi * rtb_Sum_c_idx_0 + rtb_kxj_p * rtb_ixk_p) * 2.0;

  /* Fcn: '<S18>/fcn5' */
  rtb_kxj_p = ((rtb_kxj_p * rtb_kxj_p - rtb_ixk_p * rtb_ixk_p) - rtb_jxi *
               rtb_jxi) + rtb_Sum_c_idx_0 * rtb_Sum_c_idx_0;

  /* Trigonometry: '<S18>/Trigonometric Function3' */
  DynModel_B->VectorConcatenate_i[2] = atan2(rtb_Abs1, rtb_kxj_p);
  if (rtmIsMajorTimeStep(DynModel_M)) {
   ...
   *  Sum: '<S6>/Add1'
   */
  rtb_kxj_p = (-DynModel_B->pqr[0] * DynModel_B->Product2_p[0] +
               DynModel_B->moments[0]) + DynModel_B->Saturation1[0];
  rtb_jxi = (-DynModel_B->pqr[1] * DynModel_B->Product2_p[1] +
  ...
  /* Product: '<S37>/Product' */
  for (rtb_y = 0; rtb_y < 3; rtb_y++) {
    rtb_Sum_m[rtb_y] = DynModel_ConstB.Selector[rtb_y + 6] * DynModel_B->pqr[2]
      + (DynModel_ConstB.Selector[rtb_y + 3] * DynModel_B->pqr[1] +
         DynModel_ConstB.Selector[rtb_y] * DynModel_B->pqr[0]);
  }
   ...
   *  Sum: '<S39>/Sum'
   */
  rtb_Add6_0[0] = rtb_kxj_p - (DynModel_B->pqr[1] * rtb_Sum_m[2] -
    DynModel_B->pqr[2] * rtb_Sum_m[1]);
  rtb_Add6_0[1] = rtb_jxi - (DynModel_B->pqr[2] * rtb_Sum_m[0] - DynModel_B->
    pqr[0] * rtb_Sum_m[2]);
  rtb_Add6_0[2] = rtb_ixk_p - (DynModel_B->pqr[0] * rtb_Sum_m[1] -
    DynModel_B->pqr[1] * rtb_Sum_m[0]);
  ...
  if (rtmIsMajorTimeStep(DynModel_M)) {
    ...
    rtb_Sum_h_idx_1 = (rtb_Sum_h_idx_1 - rtb_ZeroOrderHold2_idx_1) +
      rtb_Saturation_p[1];
    rtb_Abs1 = (rtb_Sum_h_idx_2 - rtb_ZeroOrderHold2_idx_2) + rtb_Saturation_p[2];

    /* Product: '<S118>/Product' incorporates:
     *  Constant: '<S118>/Scale factors & Cross-coupling  errors'
     */
    for (rtb_y = 0; rtb_y < 3; rtb_y++) {
      rtb_Saturation_p[rtb_y] = DynModel_ConstP.pooled23[rtb_y + 6] * rtb_Abs1 +
        (DynModel_ConstP.pooled23[rtb_y + 3] * rtb_Sum_h_idx_1 +
         DynModel_ConstP.pooled23[rtb_y] * rtb_Sum_h_idx_0);
    }

    /* End of Product: '<S118>/Product' */

    /* Sum: '<S118>/Sum4' */
    rtb_Sum_m[1] = rtb_Saturation_p[1];
    rtb_Sum_m[2] = rtb_Saturation_p[2];
     ...
     *  Sum: '<S118>/Sum4'
     */
    rtb_Abs1 = 0.011180339887498949 * DynModel_DW->NextOutput_k[0] +
      rtb_Saturation_p[0];
    if (rtb_Abs1 > 19.62) {
      rtb_Saturation_p[0] = 19.62;
    } else if (rtb_Abs1 < -19.62) {
      rtb_Saturation_p[0] = -19.62;
    } else {
      rtb_Saturation_p[0] = rtb_Abs1;
    }

    rtb_Abs1 = 0.011180339887498949 * DynModel_DW->NextOutput_k[1] + rtb_Sum_m[1];
    if (rtb_Abs1 > 19.62) {
      rtb_Saturation_p[1] = 19.62;
    } else if (rtb_Abs1 < -19.62) {
      rtb_Saturation_p[1] = -19.62;
    } else {
      rtb_Saturation_p[1] = rtb_Abs1;
    }

    rtb_Abs1 = 0.011180339887498949 * DynModel_DW->NextOutput_k[2] + rtb_Sum_m[2];
    if (rtb_Abs1 > 19.62) {
      rtb_Saturation_p[2] = 19.62;
    } else if (rtb_Abs1 < -19.62) {
      rtb_Saturation_p[2] = -19.62;
    } else {
      rtb_Saturation_p[2] = rtb_Abs1;
    }
     ...
     */
    for (rtb_y = 0; rtb_y < 3; rtb_y++) {
      rtb_Product_k4[rtb_y] = DynModel_ConstP.pooled23[rtb_y + 6] *
        DynModel_B->pqr[2] + (DynModel_ConstP.pooled23[rtb_y + 3] *
        DynModel_B->pqr[1] + DynModel_ConstP.pooled23[rtb_y] * DynModel_B->pqr[0]);
    }
  ...
  if (rtmIsMajorTimeStep(DynModel_M)) {
     ...
     *  Sum: '<S119>/Sum4'
     */
    rtb_Saturation_l3_idx_0 = 0.00070710678118654762 * DynModel_DW->
      NextOutput_p[0] + rtb_Product_k4[0];
    ...
    rtb_Saturation_l3_idx_1 = 0.00070710678118654762 * DynModel_DW->
      NextOutput_p[1] + rtb_Product_k4[1];
    ...
    rtb_Saturation_l3_idx_2 = 0.00070710678118654762 * DynModel_DW->
      NextOutput_p[2] + rtb_Product_k4[2];
  ...
  /* Sum: '<S75>/Add' */
  rtb_Sum_c_idx_0 = (DynModel_B->VectorConcatenate[0] +
   ...
   */
  if (rtmIsMajorTimeStep(DynModel_M)) {
    DynModel_DW->If_ActiveSubsystem = (int8_T)!(rtb_Sum_c_idx_0 > 0.0);
  }
  ...
  switch (DynModel_DW->If_ActiveSubsystem) {
   case 0L:
     ...
     *  Sum: '<S75>/Add'
     */
    rtb_Abs1 = sqrt(rtb_Sum_c_idx_0 + 1.0);

    /* Gain: '<S74>/Gain' */
    DynModel_B->Merge[0] = 0.5 * rtb_Abs1;
    ...
    DynModel_B->Merge[1] = (DynModel_B->VectorConcatenate[7] -
      DynModel_B->VectorConcatenate[5]) / rtb_Abs1;
    DynModel_B->Merge[2] = (DynModel_B->VectorConcatenate[2] -
      DynModel_B->VectorConcatenate[6]) / rtb_Abs1;
    DynModel_B->Merge[3] = (DynModel_B->VectorConcatenate[3] -
      DynModel_B->VectorConcatenate[1]) / rtb_Abs1;
   ...
   case 1L:
     ...
     */
    /* If: '<S73>/Find Maximum Diagonal Value' */
    if (rtmIsMajorTimeStep(DynModel_M)) {
      ...
      } else if (DynModel_B->VectorConcatenate[8] >
    ...
    switch (DynModel_DW->FindMaximumDiagonalValue_ActiveSubsystem) {
     case 0L:
       ...
       *  Sum: '<S89>/Add'
       */
      rtb_Abs1 = sqrt(((DynModel_B->VectorConcatenate[4] -
                        DynModel_B->VectorConcatenate[0]) -
                       DynModel_B->VectorConcatenate[8]) + 1.0);

      /* Gain: '<S77>/Gain' */
      DynModel_B->Merge[2] = 0.5 * rtb_Abs1;
      ...
      /* Product: '<S88>/Product' */
      rtb_Abs1 = rtb_Sum_c_idx_0 / rtb_Abs1;
      ...
      DynModel_B->Merge[1] = (DynModel_B->VectorConcatenate[1] +
        DynModel_B->VectorConcatenate[3]) * rtb_Abs1;
      ...
      DynModel_B->Merge[3] = (DynModel_B->VectorConcatenate[5] +
        DynModel_B->VectorConcatenate[7]) * rtb_Abs1;
     ...
     case 1L:
       ...
       *  Sum: '<S94>/Add'
       */
      rtb_Abs1 = sqrt(((DynModel_B->VectorConcatenate[8] -
                        DynModel_B->VectorConcatenate[0]) -
                       DynModel_B->VectorConcatenate[4]) + 1.0);

      /* Gain: '<S78>/Gain' */
      DynModel_B->Merge[3] = 0.5 * rtb_Abs1;
     ...
     case 2L:
       ...
       *  Sum: '<S84>/Add'
       */
      rtb_Abs1 = sqrt(((DynModel_B->VectorConcatenate[0] -
                        DynModel_B->VectorConcatenate[4]) -
                       DynModel_B->VectorConcatenate[8]) + 1.0);

      /* Gain: '<S76>/Gain' */
      DynModel_B->Merge[1] = 0.5 * rtb_Abs1;
  ...
  rtb_Sum_c_idx_0 = ((rtb_q0q1q2q3[0] * rtb_q0q1q2q3[0] + rtb_q0q1q2q3[1] *
                      rtb_q0q1q2q3[1]) + rtb_q0q1q2q3[2] * rtb_q0q1q2q3[2]) +
    rtb_q0q1q2q3[3] * rtb_q0q1q2q3[3];
  ...
  DynModel_B->q0dot = ((rtb_q0q1q2q3[1] * DynModel_B->pqr[0] + rtb_q0q1q2q3[2] *
                       ...
                       [2]) * -0.5 + (1.0 - rtb_Sum_c_idx_0) * rtb_q0q1q2q3[0];
  ...
  DynModel_B->q1dot = ((rtb_q0q1q2q3[0] * DynModel_B->pqr[0] + rtb_q0q1q2q3[2] *
                       ...
                       [1]) * 0.5 + (1.0 - rtb_Sum_c_idx_0) * rtb_q0q1q2q3[1];
  ...
  DynModel_B->q2dot = ((rtb_q0q1q2q3[0] * DynModel_B->pqr[1] + rtb_q0q1q2q3[3] *
                       ...
                       [2]) * 0.5 + (1.0 - rtb_Sum_c_idx_0) * rtb_q0q1q2q3[2];
  ...
  DynModel_B->q3dot = ((rtb_q0q1q2q3[0] * DynModel_B->pqr[2] + rtb_q0q1q2q3[1] *
                       ...
                       [0]) * 0.5 + (1.0 - rtb_Sum_c_idx_0) * rtb_q0q1q2q3[3];
  ...
  if (rtmIsMajorTimeStep(DynModel_M)) {
     ...
     */
    DynModel_Y->Gps_Lat = (real32_T)rtb_Add3_idx_0;

    /* Outport: '<Root>/Gps_Lon' incorporates:
     *  DataTypeConversion: '<S1>/Data Type Conversion6'
     */
    DynModel_Y->Gps_Lon = (real32_T)rtb_Add3_idx_1;
    ...
    DynModel_Y->Gps_V_Mod = (real32_T)sqrt((rtb_Add2_h_idx_0 * rtb_Add2_h_idx_0
      + rtb_Add2_h_idx_1 * rtb_Add2_h_idx_1) + rtb_Add2_h_idx_2 *
      rtb_Add2_h_idx_2);

    /* Outport: '<Root>/COG' incorporates:
     *  DataTypeConversion: '<S1>/Data Type Conversion9'
     */
    DynModel_Y->COG = (real32_T)rtb_Switch;
  }
   ...
   */
  if (fabs(rtb_Sum_i) > 180.0) {
    rtb_Sum_i = rt_modd(rtb_Sum_i + 180.0, 360.0) + -180.0;
  }
   ...
   *  Sum: '<S70>/Add1'
   */
  DynModel_Y->Lat_Lon_Alt[1] = (real32_T)(DynModel_U->Initial_LL[1] + rtb_Sum_i);
   ...
   */
  DynModel_Y->Torques[0] = (real32_T)rtb_kxj_p;
  DynModel_Y->Torques[1] = (real32_T)rtb_jxi;
...
RT_MODEL_DynModel_T *DynModel(void)
{
...

  {
    ...
    DynModel_M->Timing.stepSize0 = sys_step_time;
